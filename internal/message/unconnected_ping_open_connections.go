...
func (pk *UnconnectedPingOpenConnections) MarshalBinary() (data []byte, err error) {
	b := make([]byte, 33)
	b[0] = IDUnconnectedPingOpenConnections
...
func (pk *UnconnectedPingOpenConnections) UnmarshalBinary(data []byte) error {
	if len(data) < 32 {
